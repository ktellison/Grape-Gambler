...
with col1:
    total_grapes_input = st.number_input("Enter total number of grapes", min_value=2, max_value=1000, value=10, step=1)
with col2:
    total_grapes = st.slider("Total number of grapes", 2, 1000, value=total_grapes_input, step=1)

# Dual input: poison grapes
col3, col4 = st.columns(2)
with col3:
    poison_grapes_input = st.number_input("Enter number of poison grapes", min_value=1, max_value=total_grapes - 1, value=1, step=1)
with col4:
    poison_grapes = st.slider("Number of poison grapes", 1, total_grapes - 1, value=poison_grapes_input, step=1)

# Dual input: grapes eaten
col5, col6 = st.columns(2)
with col5:
    grapes_eaten_input = st.number_input("Enter number of grapes to eat", min_value=1, max_value=total_grapes, value=1, step=1)
with col6:
    grapes_eaten = st.slider("Number of grapes you want to eat", 1, total_grapes, value=grapes_eaten_input, step=1)
